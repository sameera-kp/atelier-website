...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://sameeranaf.pythonanywhere.com/api/register/", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        setStatus(JSON.stringify(data) || "Registration failed.");
      }
    } catch (error) {
    ...
    <main className="min-h-screen px-6 md:px-12 py-16 max-w-xl mx-auto flex flex-col justify-center">
      ...
      >
        ...
        <h1 className="text-4xl font-light tracking-tight">
          CREATE AN <span className="italic font-serif text-neutral-400">ACCOUNT</span>
        </h1>
      </motion.section>
